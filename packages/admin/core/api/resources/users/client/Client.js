...
class Users {
    ...
    async list() {
        ...
        if (_response.ok) {
            return await serializers.UsersList.parseOrThrow(_response.body, {
    ...
    async create(request) {
        const _response = await core.fetcher({
            ...
            contentType: "application/json",
            body: await serializers.UserCreateParams.jsonOrThrow(request, { unrecognizedObjectKeys: "strip" }),
        });
        if (_response.ok) {
            return await serializers.User.parseOrThrow(_response.body, {
                unrecognizedObjectKeys: "passthrough",
