...
class Agents {
    ...
    list() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            const _response = yield core.fetcher({
                url: (0, url_join_1.default)((_a = (yield core.Supplier.get(this.options.environment))) !== null && _a !== void 0 ? _a : environments.ProficientEnvironment.Production, "/agents"),
                method: "GET",
                headers: {
    ...
    get(agentId) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            const _response = yield core.fetcher({
                url: (0, url_join_1.default)((_a = (yield core.Supplier.get(this.options.environment))) !== null && _a !== void 0 ? _a : environments.ProficientEnvironment.Production, `/agents/${yield serializers.AgentId.jsonOrThrow(agentId)}`),
                method: "GET",
                headers: {
                    Authorization: yield this._getAuthorizationHeader(),
                    "X-PROFICIENT-API-KEY": (yield core.Supplier.get(this.options.apiKey)) != null
    ...
    getConfig(agentId) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            const _response = yield core.fetcher({
                url: (0, url_join_1.default)((_a = (yield core.Supplier.get(this.options.environment))) !== null && _a !== void 0 ? _a : environments.ProficientEnvironment.Production, `/agents/${yield serializers.AgentId.jsonOrThrow(agentId)}/config`),
                method: "GET",
                headers: {
                    Authorization: yield this._getAuthorizationHeader(),
                    "X-PROFICIENT-API-KEY": (yield core.Supplier.get(this.options.apiKey)) != null
    ...
    activate(agentId) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            const _response = yield core.fetcher({
                url: (0, url_join_1.default)((_a = (yield core.Supplier.get(this.options.environment))) !== null && _a !== void 0 ? _a : environments.ProficientEnvironment.Production, `/agents/${yield serializers.AgentId.jsonOrThrow(agentId)}/activate`),
                method: "POST",
                headers: {
                    Authorization: yield this._getAuthorizationHeader(),
                    "X-PROFICIENT-API-KEY": (yield core.Supplier.get(this.options.apiKey)) != null
    ...
    deactivate(agentId) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            const _response = yield core.fetcher({
                url: (0, url_join_1.default)((_a = (yield core.Supplier.get(this.options.environment))) !== null && _a !== void 0 ? _a : environments.ProficientEnvironment.Production, `/agents/${yield serializers.AgentId.jsonOrThrow(agentId)}/deactivate`),
                method: "POST",
                headers: {
                    Authorization: yield this._getAuthorizationHeader(),
                    "X-PROFICIENT-API-KEY": (yield core.Supplier.get(this.options.apiKey)) != null
